# To check if higher or lower game
import random
from sys import flags
import game_data
import art

# first randomly pick two personalities ,    both different 
...
while(flag!=False):
    ...
    # print(first)
    # print(second)
    print("Compare A: "+first["name"]+", "+first["description"])
    print(art.vs)
    print("Against B: "+second["name"]+", "+second["description"])
